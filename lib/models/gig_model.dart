...
extension GigStatusLabel on GigStatus {
  String get label {
    switch (this) {
      case GigStatus.open:                   return 'OPEN';
      case GigStatus.accepted:               return 'ACCEPTED';
      case GigStatus.inProgress:             return 'IN PROGRESS';
      case GigStatus.completedPendingReview: return 'PENDING REVIEW';
      case GigStatus.closed:                 return 'CLOSED';
      case GigStatus.cancelled:              return 'CANCELLED';
      case GigStatus.reported:               return 'REPORTED';
    }
  }
  ...
  String get firestoreValue {
    switch (this) {
      case GigStatus.open:                   return 'open';
      case GigStatus.accepted:               return 'accepted';
      case GigStatus.inProgress:             return 'inProgress';
      case GigStatus.completedPendingReview: return 'completedPendingReview';
      case GigStatus.closed:                 return 'closed';
      case GigStatus.cancelled:              return 'cancelled';
      case GigStatus.reported:               return 'reported';
    }
...
extension GigCategoryLabel on GigCategory {
  String get label {
    switch (this) {
      ...
      case GigCategory.delivery: return 'Delivery';
      case GigCategory.writing:  return 'Writing';
      case GigCategory.coding:   return 'Coding';
      case GigCategory.errands:  return 'Errands';
  ...
  String get emoji {
    switch (this) {
      case GigCategory.tutoring: return '📚';
      case GigCategory.delivery: return '🚚';
      case GigCategory.writing:  return '✍️';
      case GigCategory.coding:   return '💻';
      case GigCategory.errands:  return '🏃';
      case GigCategory.other:    return '⚡';
    }
  }
}
...
class GigModel {
  ...
  factory GigModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return GigModel(
      ...
      acceptedAt:  d['acceptedAt']  != null ? (d['acceptedAt']  as Timestamp).toDate() : null,
      startedAt:   d['startedAt']   != null ? (d['startedAt']   as Timestamp).toDate() : null,
      completedAt: d['completedAt'] != null ? (d['completedAt'] as Timestamp).toDate() : null,
      closedAt:    d['closedAt']    != null ? (d['closedAt']    as Timestamp).toDate() : null,
