              ...
              owned.when(
                ...
                data:    (items) => items.isEmpty
                  ? _EmptyState(
                      ...
                      onAction: () => Navigator.pushNamed(context, '/rentals/list'),
                    )
              ...
              borrowed.when(
                ...
                data:    (items) => items.isEmpty
                  ? _EmptyState(
                      ...
                      onAction: () => Navigator.pushNamed(context, '/rentals'),
                    )
  ...
  Widget _appBar() => SliverToBoxAdapter(
    child: Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Manage items you own and items you borrow.',
  ...
  Widget _tabBar() => SliverPersistentHeader(
    ...
    delegate: _StickyTab(
      TabBar(
        ...
        tabs: [
          _tabItem('My Items',  ref.watch(myOwnedRentalsProvider).valueOrNull?.length),
          _tabItem('Borrowing', ref.watch(myBorrowedRentalsProvider).valueOrNull?.length),
        ],
      ),
    ),
  );
    ...
    child: Row(mainAxisSize: MainAxisSize.min, children: [
      ...
      if (count != null && count > 0) ...[
        ...
        Container(
          ...
          child: Text('$count',
            style: GoogleFonts.syne(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.cyan)),
        ),
      ],
    ]),
  );
...
class _RentalList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final active = items.where((r) => activeStatuses.contains(r.status)).toList();
    final done   = items.where((r) => !activeStatuses.contains(r.status)).toList();
...
class _RentalCard extends ConsumerWidget {
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Container(
            ...
            child: Center(child: Text(rental.category.emoji,
        ...
        Row(children: [
          ...
          Text('/day', style: AppText.body(size: 12, color: AppColors.textMuted)),
          if (rental.deposit > 0) ...[
            const SizedBox(width: 10),
            Text('+ ₹${rental.deposit} deposit',
        ...
        if (rental.rentalStart != null && rental.rentalEnd != null) ...[
          ...
          Row(children: [
            const Icon(Icons.date_range_rounded, size: 13, color: AppColors.textMuted),
        ...
        if (rental.isActive && rental.rentalDays > 0) ...[
          ...
          Container(
            ...
            child: Row(children: [
              Text('Total value', style: AppText.body(size: 12, color: AppColors.textMuted)),
              const Spacer(),
              Text('₹${rental.totalCost}',
                style: GoogleFonts.syne(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.lime)),
            ]),
          ),
        ],
        ...
        return [
          ...
          Row(children: [
            Expanded(child: _ActionButton(
              ...
              onTap: () => _confirm(context, 'Reject this rental request?', () async {
            ...
            Expanded(child: _ActionButton(
              ...
              onTap: () => _confirm(context, 'Approve rental request?', () async {
      ...
      if (rental.isReturnPending) {
        return [
          ...
          _ActionButton(
            ...
            onTap: () => _confirm(context, 'Confirm you received the item back?', () async {
    ...
    if (role == _RentalRole.renter) {
      if (rental.isActive) {
        return [
          const SizedBox(height: 12),
          _ActionButton(
            label: rental.isOverdue ? 'Return Item (Overdue!)' : 'Initiate Return',
  ...
  Color _catColor(RentalCategory cat) {
    switch (cat) {
      case RentalCategory.electronics: return AppColors.cyan;
      case RentalCategory.labGear:     return AppColors.violet;
      case RentalCategory.books:       return AppColors.lime;
      case RentalCategory.sports:      return AppColors.coral;
      case RentalCategory.clothing:    return AppColors.amber;
      case RentalCategory.other:       return const Color(0xFF7777AA);
    }
  }
...
class _StatusPill extends StatelessWidget {
  ...
  Color get _color {
    switch (status) {
      case RentalStatus.available:     return AppColors.lime;
      case RentalStatus.requested:     return AppColors.amber;
      case RentalStatus.active:        return AppColors.cyan;
      case RentalStatus.returnPending: return AppColors.violet;
      case RentalStatus.completed:     return AppColors.textMuted;
      case RentalStatus.disputed:      return AppColors.coral;
      case RentalStatus.cancelled:     return AppColors.coral;
    }
  }
...
class _OverduePill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Text('OVERDUE', style: AppText.label(size: 10, color: AppColors.coral)),
  );
}
    ...
    actions: [
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          child: Text('Confirm',
            style: GoogleFonts.syne(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.black)),
        ),
      ),
    ],
  );
